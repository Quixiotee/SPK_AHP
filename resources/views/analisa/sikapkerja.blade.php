...
<div class="row">
    <div class="col-3">
        <div class="card-box">
            ...
            <nav class="navbar navbar-light">
                <button type="button" class="btn btn-light btn-sm btn-block active"><a class="navbar-brand" href="{{route('analisa.sikapkerja')}}">Sikap Kerja</a></button>
            </nav>
            <nav class="navbar navbar-light">
        ...
        <div class="card-box">
            ...
            <div class="">
                <table class="data-table table">
                    ...
                    <tbody>
                        @foreach($arry_sikapkerja as $data)
                        <tr>
                            <td>{{$data['nama_guru']}}</td>
                            <td>{{$data['sikapkerja']}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                for ($i = 0; $i < count($alternatif); $i++) {
                    ...
                    for ($j = 0; $j < count($alternatif); $j++) {
                        echo "<td>" . $perbandingan_sikapkerja[$i][$j] . "</td>";
                    }
                    $a++;
                }
                echo "</tr>";
            ...
            <thead>
                <tr>
                    ...
                    <?php
                    for ($i = 0; $i < count($alternatif); $i++) {
                        echo "<th><b>" . $penjumlahan_perbandingan_sikapkerja[0][$i] . "</b></th>";
                    }
                    ?>
                </tr>
            </thead>
...
<div class="card-box pd-20 height-25-p mb-30">
    <div class="col-md-8">
        ...
        $b = 1;
        for ($i = 0; $i < count($alternatif); $i++) {
            echo "A" . $a . " = <b>" . $rata_rata_kriteria_sikapkerja[$i][0] . "</b><br>";
            $a = $a + 1;
        }
        ?>
    </div>
