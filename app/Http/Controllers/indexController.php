    ...
    public function index()
    {
        ...
        foreach ($guru as $data) {
            ...
            if (!$cekalternatif) {
                ...
                $absen = absensi::where('nip', $data->nip)->where('status', 'Alpha')->orWhere('status', 'Sakit')->orWhere('status', 'Izin')->count();

                $waktu = absensi::where('nip', $data->nip)->whereTime('jam_masuk', '>', '07:00:00')->count();
